...
Веб-приложение на PHP для обучения игре на цифровом пианино. Подключает MIDI-пианино по USB, показывает виртуальную клавиатуру и проверяет, правильно ли вы нажимаете ноты мелодии.
