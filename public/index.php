...
$auth->setSubscriptionService($subscriptions);
$router = new Router($repository, $blogRepository, new MidiSearch(), $auth, $stats, $oauth, $roadmap, $admin, $teacher, $roles, $analytics, $subscriptions, $payments);
